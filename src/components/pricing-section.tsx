...
const PLANS = [
  ...
  },
  {
    ...
    price: "$25",
    period: "/month",
    description: "For agents scaling in production",
    features: [
      "Everything in Free",
      "Up to 2M memories",
  ...
  },
  {
    ...
    price: "$399",
    period: "/month",
    description: "For enterprise-grade deployments",
    features: [
      "Everything in Pro",
      "Unlimited memories",
      "Self-hosting option",
  ...
  return (
    <section id="pricing" className="w-full px-6 py-20 lg:px-20">
          ...
          >
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                {plan.highlight && (
                  <span className="text-[9px] font-mono tracking-widest uppercase px-2 py-0.5 bg-[#0001FC] text-white">
                    POPULAR
                  </span>
                )}
              </div>
            ...
            <div className="flex flex-col gap-2.5 flex-1 mb-8">
              {plan.features.map((feature) => (
                <div key={feature} className="flex items-start gap-2.5">
                  <Check size={12} className={`mt-0.5 shrink-0 ${plan.highlight ? "text-[#0001FC]" : "text-[#0001FC]"}`} strokeWidth={3} />
      ...
      >
        ...
        <Link
          href="https://github.com/0xshubhs/hydradb1/blob/main/completion.md"
          target="_blank"
          rel="noreferrer"
